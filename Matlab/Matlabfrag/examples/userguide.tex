...
{\verb|pdflatex -shell-escape example.tex|}\par\noindent
  ...
  \section{Frequently (occasionally) asked questions}%
    ...
    \section{Advanced usage: a discussion on renderers}\seclabel{renderers}%
      ...
      As of \matlabfrag\ {\ttfamily v0.6.0}, an {\ttfamily EXPORTFIG} and {\ttfamily epscombine} style hack
      ...
      a very large \eps\ file. During the conversion to {\ttfamily pdf} the image is compressed to a {\ttfamily jpeg}
      file (unfortunately it can't be compressed to a {\ttfamily png} file using {\ttfamily ps2pdf} to my
      knowledge), so it is reduced to a reasonable file size (at the expense of some image quality).
   ...
   \section{Additional tests}\seclabel{testing}%
     ...
     \begin{figure}[ht]
       ...
       \caption{Output from \ttfamily{test01.m}}
       \figlabel{test01}
     \end{figure}
     \begin{figure}[ht]
       \centering
       \psfragfig{graphics/test02}
       \caption{Output from \ttfamily{test02.m}}
       \figlabel{test02}
     \end{figure}
     \begin{figure}[ht]
       \centering
       \psfragfig{graphics/test03}
       \caption{Output from \ttfamily{test03.m}}
       \figlabel{test03}
     \end{figure}
     \begin{figure}[ht]
       \centering
       \psfragfig{graphics/test04}
       \caption{Output from \ttfamily{test04.m}}
       \figlabel{test04}
     \end{figure}
     \begin{figure}[ht]
       \centering
       \psfragfig{graphics/test05}
       \caption{Output from \ttfamily{test05.m}}
       \figlabel{test05}
     \end{figure}     
\end{document}

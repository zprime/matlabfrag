...
{\verb|pdflatex -shell-escape example.tex|}\par\noindent
  ...
  \section{Frequently (occasionally) asked questions}%
   ...
   \section{Advanced usage: a discussion on axis ticks}\seclabel{adv-axis}%
     ...
     Unfortunately I don't understand how this works (if someone cares to elighten me, please do. My
     email address appears often in this document.), but by resetting the {\ttfamily xticklabelmode} to
     {\ttfamily auto} \matlabfrag\ is able to automatically recreate the scaling values. An example of
     how to do this is given in\par

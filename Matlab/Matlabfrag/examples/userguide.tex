...
{\verb|pdflatex -shell-escape example.tex|}\par\noindent
  ...
  \section{Creating figures in \matlab}%
    ...
    \subsection{Tick scaling values}\seclabel{axis-scaling}%
      ...
      See \Figref{ex13} for the output.
      \begin{figure}[ht]
        \centering
  ...
  \section{Frequently (occasionally) asked questions}%
    ...
    \section{Advanced usage: a discussion on renderers}\seclabel{renderers}%
      ...
      \VerbatimInput[firstline=7,lastline=15]{ex15.m}
      The output for this example is given in \Figref{ex15}.
      \begin{figure}[ht]
        \centering
      ...
      \VerbatimInput[firstline=41,lastline=45]{ex16.m}
      The output from this example is given in \Figref{ex16}.
      \begin{figure}[ht]
        \centering
   ...
   \section{Advanced usage: a discussion on axis ticks}\seclabel{adv-axis}%
     ...
     \VerbatimInput[firstline=7,lastline=8]{ex14.m}
     which produces \Figref{ex14}.
     \begin{figure}[ht]
       \centering

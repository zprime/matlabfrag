...
\newcommand\matlabfrag{\href{http://www.mathworks.com/matlabcentral/fileexchange/21286}{{\ttfamily matlabfrag}}}
\newcommand\psfragname{\href{http://www.ctan.org/tex-archive/help/Catalogue/entries/psfrag.html}{{\ttfamily psfrag}}}
\newcommand\pstoolname{\href{http://www.ctan.org/tex-archive/help/Catalogue/entries/pstool.html}{{\ttfamily pstool}}}
...
\begin{document}
  ...
  \section{Compared to LaPrint}%
    ...
    {\verb|graphics/comparison01.m|}\par\noindent
    ...
    \begin{figure}[ht]
      \centering
      \subfloat[graphics/comparison01-matlabfrag]{\fbox{\psfragfig{graphics/comparison01-matlabfrag}}}
      \,
...
{\verb|pdflatex -shell-escape example.tex|}\par\noindent
  ...
  \section{Frequently (occasionally) asked questions}%
    \subsection*{Why does the output have [`number'] in it?}
	  ...
	  \subsection*{Why doesn't the \tex\ file have the {\ttfamily includegraphics} statement in it like
	  LaPrint does?}
    ...
    \section{Troubleshooting}
      \subsection{I get an error in \matlab!}
        \matlabfrag\ should not generate any errors from user behaviour, so it is most likely a bug.
    ...
    \subsection{My graphic exports from \matlab\ and compiles in LaTeX/pdfLaTeX/LyX but doesn't look right!}
      \begin{enumerate}
      ...
      \begin{enumerate}
        ...
        \item If you have mathematical equations, use the {\ttfamily latex} interpreter. This will make the
          the text object be roughly the right size, which will let \matlab\ place it properly. This is
          especially useful for legends.
        \item If the text appears to be cropped from the outside of the graphic, try padding the \eps\
          document using the {\ttfamily epspad} option, or try switching to the {\ttfamily pdfcrop} option
          for \pstoolname:\par
   ...
   \section{Advanced usage: a discussion on axis scales}
     \begin{figure}[ht]
       \centering
       \psfragfig{graphics/ex12}
       \caption{Axis scale positions.}
       \figlabel{ex12}
     \end{figure}
     \begin{figure}[ht]
       \centering

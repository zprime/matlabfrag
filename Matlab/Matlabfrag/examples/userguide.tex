...
\usepackage{upquote,fancyvrb,subfig}
...
matlabfrag(FileName,OPTIONS)
      ...
      \VerbatimInput[firstline=7]{ex02.m}

      \begin{figure}[ht]
        \centering
        \psfragfig{graphics/ex02}
        \caption{X-label should say `Plays nice with \LaTeX'.}
      \end{figure}
...
{\verb|pdflatex -shell-escape example.tex|}\par\noindent
  ...
  \section{Creating figures in \matlab}%
    ...
    \subsection{Sizing}%
      ...
      \VerbatimInput[firstline=4,lastline=9]{ex03.m}
      \begin{figure}[ht]
        \centering
        \psfragfig{graphics/ex03}
        \caption{Figure sized to 8cm by 3cm.}
      \end{figure}
    ...
    \subsection{{\tt Color}}%
      ...
      \VerbatimInput[firstline=8,lastline=11]{ex04.m}
      \begin{figure}[ht]
        \centering
        \psfragfig{graphics/ex04}
        \caption{Text should be coloured.}
      \end{figure}
    ...
    \subsection{{\tt FontSize}}%
      ...
      \VerbatimInput[firstline=8,lastline=11]{ex05.m}
      \begin{figure}[ht]
        \centering
        \psfragfig{graphics/ex05}
        \caption{Text should be different sizes.}
      \end{figure}
    ...
    \subsection{{\tt FontAngle}}%
      ...
      document.
      \VerbatimInput[firstline=8,lastline=11]{ex06.m}
      \begin{figure}[ht]
        \centering
        \psfragfig{graphics/ex06}
        \caption{Oblique and Italic font should both be italic here.}
      \end{figure}
    ...
    \subsection{{\tt FontWeight}}%
      ...
      \VerbatimInput[firstline=8,lastline=12]{ex07.m}
      \begin{figure}[ht]
        \centering
        \psfragfig{graphics/ex07}
        \caption{Bold should be bold, demi and light do not really translate to LaTeX, so they should
          default to normal.}
      \end{figure}
    ...
    \subsection{{\tt FontName}}%
      ...
      \verb|\ttfamily|).
      \VerbatimInput[firstline=8,lastline=11]{ex08.m}
      \begin{figure}[ht]
        \centering
        \psfragfig{graphics/ex08}
        \caption{Fixed-width should be in a fixed-width font, while Comic Sans should be changed to the
    ...
    \subsection{{\tt Interpreter}}%
      ...
      {\tt tex} interpreter if rendering anything mathematical and using \matlabfrag. The {\tt latex}
      interpreter is especially useful for rendering mathematical formula.
      \VerbatimInput[firstline=8,lastline=11]{ex09.m}
	  \begin{figure}[ht]
	    \centering
		\psfragfig{graphics/ex09}
		\caption{Both equations should be the same, despite using a different interpreter in \matlab.}
	  \end{figure}
    ...
    \subsection{Multi-line text}%
	  ...
	  \VerbatimInput[firstline=8,lastline=13]{ex10.m}
	  \begin{figure}[ht]
	    \centering
		\psfragfig{graphics/ex10}
		\caption{Three different ways to make multiline text. 2D arrays, cells and using {\tt tabular}.}
	  \end{figure}
  ...
  \section{Frequently (occasionally) asked questions}%
    \subsection*{Why does the output have [`number'] in it?}
	  ...
	  \par\noindent Firstly, read the Background section above. With all the image files stored in a
    ...
    \section{Troubleshooting}	
	  \begin{enumerate}
	    \item Check that all LaTeX statements in your figure are valid. If you are having problems, try a
	      simple example that is know to work.
	    \item If using pdfLaTeX and \pstoolname, check:
	    \begin{enumerate}
	      \item \verb|-shell-escape| option is set calling pdfLaTeX.
	    \end{enumerate}
